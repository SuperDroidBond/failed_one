...
public class VibratorStrengthPreference extends SeekBarDialogPreference implements
    ...
    public static void restore(Context context) {
        ...
        String storedValue = PreferenceManager.getDefaultSharedPreferences(context).getString(TouchscreenGestureSettings.KEY_VIBSTRENGTH, "2700"); 
    ...
    protected void onDialogClosed(boolean positiveResult) {
        ...
        if (positiveResult) {
            ...
            editor.putString(TouchscreenGestureSettings.KEY_VIBSTRENGTH, String.valueOf(value));
            editor.commit();
        } else {
            restoreOldState();
        }
